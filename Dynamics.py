...
class Dynamics(ABC):  
    @abstractmethod
    def getInitialFullStateFromIntegrables(self, integrableStates : dict, t):
        pass

    @abstractmethod
    def getNextFullState(self, lastFullState : dict, t):
        pass
    ...
    def getFullStateNames(self):
        stateUnitProperties = self.getStateUnitProperties()
        return stateUnitProperties.keys()
...
#         self.parameterProperties = {"P_A" : StateUnitProperties("accumulatorPressure", "Pa", "bar", 1e-5),
...
#                                     "P_A-P_S" : StateUnitProperties("P_A - P_S", "Pa", "bar", 1e-5)
#                                     }
